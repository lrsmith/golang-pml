...
func main() {
	...
	predictiveLine := plotter.NewFunction(func(x float64) float64 { return (x * 1.840) })
	...
	if err := plot.Save(4*vg.Inch, 4*vg.Inch, "graphs/plot_linear_regression.png"); err != nil {
		panic(err)
	}
